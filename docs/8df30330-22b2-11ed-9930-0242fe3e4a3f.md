...
<div xmlns="http://www.w3.org/1999/xhtml" className="p"><div className="note important note_important"><span className="note__title">Important:</span> <ul className="ul"><li className="li"><p className="p">You need to subscribe to the <span className="ph">Premium</span> or <span className="ph">Ultimate</span> plan. To request a trial, refer to: <a className="xref" href="/docs/administer/katalon-platform-packages/katalon-trial-plans">Katalon Trial Plans</a>.</p></li></ul></div></div>

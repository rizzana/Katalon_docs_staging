...
<ul xmlns="http://www.w3.org/1999/xhtml" className="ul">   <li className="li">[Web Testing] Support image-based object recognition. <a className="xref" href="#">Learn       more</a>   </li> </ul> 
